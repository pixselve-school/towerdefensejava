...
public class ProgressBar extends HUD_Element {
  ...
  public void Update(double MouseX, double MouseY, double delta_time) {
    ...
    StdDraw.picture(this.position.x - (this.width / 2) + (this.progressPercent / 100) * (this.width / 2), this.position.y, this.sprite_fill, (this.progressPercent / 100) * this.width, this.height);
  }
